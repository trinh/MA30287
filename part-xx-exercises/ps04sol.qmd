...
## Q1. The wine cellar problem I {.unnumbered} 
...
## Q2. The wine cellar problem II {.unnumbered} 
...
To begin, from the notes @sec-pclass3, you are given that typical parameters are
$$
...
## Q3. EBMs and variable sun output {.unnumbered}
...
## Q4. Phase line analysis {.unnumbered}
