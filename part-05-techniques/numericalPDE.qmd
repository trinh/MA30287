...
During the lectures, we will examine script `Chap10-SolvingPDEs.ipynb` on the course scripts to see an example implementation. A similar application is applied in `Chap10-winecellar.ipynb` to solve a heat equation. 
